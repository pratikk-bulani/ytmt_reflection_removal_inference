...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        # Added by me
        self.parser.add_argument('--dataset_path', type=str, default='', help='path where all the images are present for testing')
        self.parser.add_argument('--output_path', type=str, default='', help='path where the outputs should be stored')
